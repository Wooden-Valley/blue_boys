...
def login():
    ...
    try:
        ...
        return render_template(
            ...
            prompt_text=None,
            recommendation=None,
            error=f"Не удалось проверить user_id в Loginom: {e}",
        )
    ...
    if not rows:
        return render_template(
            ...
            prompt_text=None,
            recommendation=None,
            error="Клиент с таким user_id не найден в Loginom",
        )
...
def history():
    ...
    try:
        ...
        prompt_text, recommendation = rules.ask_mistral(user_id, products_text)
